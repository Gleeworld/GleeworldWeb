...
export const metadata: Metadata = {
  ...
  description:
    "Gleeworld Pharmacy offers telepharmacy and medication delivery across Nigeria. Use Medfinder to discover nearby pharmacies and get your preferred medicines. Save time with easy pickup or delivery across Nigeria. Experience automated reminders, refills, follow-up care messages, and AI-enabled pharmacist consultations — all in one app. Affordable, fast, and hassle-free access to medicines and primary care.",
  icons: {
...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      ...
      <body className="antialiased bg-white text-dark-gray dark:bg-dark-gray dark:text-white transition-colors duration-300">
        <Navbar />
        {children}
        <Newsletter />
        <Footer />
