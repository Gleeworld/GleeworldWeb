  ...
  const newsItems = [
    {
      ...
      description:
        'Leading the way in innovative healthcare solutions, Gleeworld Pharmacy proudly introduces the MedFinder app, setting a new...',
    ...
    },
    {
      ...
      description:
        "Discover how Gleeworld's cutting-edge technology is revolutionizing the landscape for small independent pharmacies, setting a...",
    ...
    },
    {
      ...
      description:
        'Effortlessly store and manage your medical information in the cloud, ensuring secure, immediate access to your health records...',
